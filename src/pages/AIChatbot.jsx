      ...
      <AnimatePresence>
        ...
        {sidebarOpen && (
          <motion.div
            ...
            className="fixed mt-14 inset-y-0 left-0 md:right z-50 w-[80vw] sm:w-[50vw] bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col shadow-xl md:hidden"
          >
              ...
              >
                <div className={`flex items-start max-w-[85%] sm:max-w-[70%]`}>
                  ...
                  >
                    ...
                    <div className="flex-shrink-0 flex items-center space-x-2 text-xs text-gray-400 dark:text-gray-500 pt-1 opacity-0 group-hover:opacity-100 transition-opacity absolute top-1 right-1">
                          {/* Copy Button */}
                          <motion.div
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.9 }}
