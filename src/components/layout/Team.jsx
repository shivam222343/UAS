        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {teamData.map((member, index) => (
            <motion.div
              ...
              className={`bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden ${birthdayMember && birthdayMember.name === member.name ? 'ring-4 ring-yellow-400' : ''
                }`}
            >
              <div className="relative">
                <img
                  src={member.img}
                  alt={member.name}
                  className={`w-full rounded-lg h-80 object-cover ${birthdayMember && birthdayMember.name === member.name ? 'border-4 border-yellow-400' : ''
                    }`}
                  loading="lazy"
                />
                ...
                <div className="flex flex-col items-center">
                  <div className='flex flex-col justify-center w-full items-center'>
                    <img
                      ...
                      className={`w-32 h-32 rounded-full object-cover mb-4 ${birthdayMember && birthdayMember.name === selectedMember.name ? 'border-4 border-yellow-400' : ''
                        }`}
                      loading="lazy"
                    />
